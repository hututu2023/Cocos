    ...
    execute: function () {
      ...
      _export("GameDataModel", GameDataModel = (_dec = ccclass('GameDataModel'), _dec(_class = class GameDataModel {
        ...
        initGame() {
          ...
          var bottomCard = this.createCard(0, (_crd && CardType === void 0 ? (_reportPossibleCrUseOfCardType({
            error: Error()
          ...
          var mainValues = [4, 6, 3, 7, 8, 2, 1];
          mainValues.forEach((val, index) => {
            var card = this.createCard(index + 1, (_crd && CardType === void 0 ? (_reportPossibleCrUseOfCardType({
              error: Error()
          ...
          var reserveValues = [9, 10, 11, 12, 13];
          reserveValues.forEach((val, index) => {
            var card = this.createCard(index + 8, (_crd && CardType === void 0 ? (_reportPossibleCrUseOfCardType({
              error: Error()
            }), CardType) : CardType).NUMBER, val, (_crd && CardState === void 0 ? (_reportPossibleCrUseOfCardState({
              error: Error()
        ...
        checkMatch(selectedCard) {
          ...
          var bottomCard = this.bottomCards[0]; // 仅数字牌匹配规则：±1
          ...
          if (selectedCard.type === (_crd && CardType === void 0 ? (_reportPossibleCrUseOfCardType({
            ...
            var diff = Math.abs(selectedCard.value - bottomCard.value);
